...
// Create white foam on the bed
const foamGeometry = new THREE.BoxGeometry(2.1, 0.29, 3.1); 
const foamMaterial = new THREE.MeshStandardMaterial({ color: 0xffffff }); 
const foamMesh = new THREE.Mesh(foamGeometry, foamMaterial);
foamMesh.position.set(-3, 0.375, 0);
scene.add(foamMesh);

// Create a red pillow on the bed
const pillowGeometry = new THREE.BoxGeometry(0.7, 0.2, 0.5); 
const pillowMaterial = new THREE.MeshStandardMaterial({ color: 0xff0000 });
const pillowMesh = new THREE.Mesh(pillowGeometry, pillowMaterial);
pillowMesh.position.set(-3, 0.70, -1); 
...
const upperWallMaterial = new THREE.MeshStandardMaterial({ color: 0x00008b });
...
const leftWallMaterial = new THREE.MeshStandardMaterial({ color: 0x00008b }); 
...
const rightWallMaterial = new THREE.MeshStandardMaterial({ color: 0x00008b }); 
...
const table2Material = new THREE.MeshStandardMaterial({ color: 0x222222 }); 
...
scene.add(table2Mesh);
    ...
    const connectingTableMaterial = new THREE.MeshStandardMaterial({ color: 0x222222 }); 
    ...
    const connectinglegTableMaterial = new THREE.MeshStandardMaterial({ color: 0x222222 });
...
const carpetMaterial = new THREE.MeshStandardMaterial({ color: 0x59B4C3  }); 
...
scene.add(carpetMesh);
    ...
    // Glow on Carpet
    const carpetLight = new THREE.PointLight(0x59B4C3, 30, 1000); 
...
const lightMaterial = new THREE.MeshBasicMaterial({ color: 0xffa500 }); 
const lightSphere = new THREE.Mesh(lightGeometry, lightMaterial);

// Moon Lamp
const pointLight = new THREE.PointLight(0xffa500, 15, 10); 
